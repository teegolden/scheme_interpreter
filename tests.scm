...
;;; ADDITIONAL TEST FOR PROBLEM 1 THROUGH 20
;;; Problem 1-2
nil
; expect ()
...
;;; Problem A5
(define b 14) (define a (define b 8)) b
; expect 8

;;; Problem B6
'('testing 'rocks 'debugging 'sucks)
; expect ((quote testing) (quote rocks) (quote debugging) (quote sucks))
...
;;; Problem 7
(begin (+ 3 (begin (define a 3) (define a (+ a 4)) (- a 3)) 2) (quote test))
; expect test

;;; Problem 8
(define make_adder (lambda (x) (lambda (y) (+ x y)))) (define b (make_adder 3)) (b 4)
; expect 7

;;; Problem 9-12
(begin (define a 17) (define b 34) (define a (+ a b))) a
; expect 51
